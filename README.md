...
1. Define Problem Statement and perform Exploratory Data Analysis
   ...
   * 1.4 Bivariate Analysis (Relationships between important variable)
...
4. Missing values and Outlier Treatment
5. Scaling - Using MinMaxScaler or StandardScaler
6. Use Logistic Regression Model from Sklearn/Statsmodel library and explain the results
